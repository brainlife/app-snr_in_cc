...
class SNRinCCFlow(Workflow):
    ...
    def run(self, input_files, maks=3, out_dir = '',
        ...
        maks : int, optional
            Number that will be appended to the file. (default '3')
        ...
        for in_file, out_f in io_it:
           ...
           .. [Jones2013] Jones, D. K., Knosche, T. R., & Turner, R. White Matter
            ...
            with open(out_dir+out_file, 'w') as myfile:
